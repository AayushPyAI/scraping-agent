...
const SCHOOL_NAME = "Seattle Area German American School";
const TARGET_URL = "https://www.sagaschool.org/meet-the-staff";
...
async function scrapeSAGASchool() {
  ...
  // Ensure dynamic staff section loads
  ...
  $("button").each((_, element) => {
    ...
    const email = ""; // Not visible on this page
