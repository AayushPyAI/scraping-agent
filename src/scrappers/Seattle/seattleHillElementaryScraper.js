...
const SCHOOL_NAME = "Seattle Hill Elementary School";
const BASE_URL = "https://www.sno.wednet.edu/contact-us";
...
async function getTotalPages(page) {
  ...
  $(".fsElementPagination a[data-page]").each((_, el) => {
    const p = parseInt($(el).attr("data-page"));
...
async function scrapePage(browser, pageNumber) {
  ...
  $(".fsConstituentItem").each((_, el) => {
    ...
    const job_title = ""; // Not shown in structure
...
// MAIN SCRAPER
async function scrapeSeattleHillElementary() {
