...
const SCHOOL_NAME = "Seattle Nativity School";
const TARGET_URL = "https://www.seattlenativity.org/our-leadership.html";
...
async function scrapeSeattleNativitySchool() {
  ...
  $(".wsite-multicol-table tbody tr td").each((_, element) => {
    const paragraph = $(element).find(".paragraph");
