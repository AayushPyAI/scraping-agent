...
const SCHOOL_NAME = "North Seattle French School";
const TARGET_URL = "https://northseattlefrenchschool.com/faculty-and-staff/";
...
async function scrapeNorthSeattleFrenchSchool() {
  ...
  $(".awsm-team-item").each((_, element) => {
    const name = $(element)
      .find(".awsm-personal-info h3")
      .text()
      .trim() || "";

    const job_title = $(element)
      .find(".awsm-personal-info span")
      .first()
      .text()
      .replace(/\s+/g, " ")
      .trim() || "";

    const email = ""; // not available on page
...
scrapeNorthSeattleFrenchSchool();
