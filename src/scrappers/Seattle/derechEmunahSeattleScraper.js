...
const SCHOOL_NAME = "Derech Emunah Seattle Girls High School";
const TARGET_URL = "https://derechemunah.com/teachers/";
...
async function scrapeDerechEmunah() {
  ...
  $(".teachers-item").each((_, element) => {
    const name = $(element)
      .find(".teachers-item-info h3")
      .text()
      .trim() || "";

    const job_title = $(element)
      .find(".teachers-item-info p")
      .first()
      .text()
      .trim() || "";

    const email = ""; // Not exposed on listing page
