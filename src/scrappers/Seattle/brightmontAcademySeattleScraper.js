...
const SCHOOL_NAME = "Brightmont Academy – Seattle";
const TARGET_URL = "https://www.brightmontacademy.com/about-us/leadership-team";
...
async function scrapeBrightmontAcademy() {
  ...
  $(".photogallery-column").each((_, element) => {
    const name = $(element)
      .find(".caption-title")
      .first()
      .text()
