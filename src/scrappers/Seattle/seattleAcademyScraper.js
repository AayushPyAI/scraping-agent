...
const TARGET_URL = "https://www.seattleacademy.org/about-us/our-leadership";
...
async function scrapeSeattleAcademy() {
  ...
  $(".fsConstituentCustom").each((_, element) => {
    const name = $(element)
      .find(".fsFullName a")
      .text()
      .trim() || "";
